...
The scoring core is vendored from `@beneficialtech/repo-ip-auditor/core` so this
...
`@beneficialtech/repo-ip-auditor/core`. The CLI, the GitHub Action, and this page
